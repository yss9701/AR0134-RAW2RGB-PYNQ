...
################################################################
# This is a generated script based on design: cv_ov5640
#
...
xilinx.com:user:bayer_capture:1.0\
xilinx.com:ip:clk_wiz:6.0\
xilinx.com:hls:frame_resize:1.0\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:user:pwm_generate:1.0\
alientek.com:user:rgb2lcd:1.4\
...
proc create_root_design { parentCell } {
  ...
  set lcd_rst_n [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 lcd_rst_n ]
  set vid_iic [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 vid_iic ]
  set vid_rst_n [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 vid_rst_n ]

  # Create ports
  set PWM_o_0 [ create_bd_port -dir O -from 3 -to 0 PWM_o_0 ]
  ...
  set vid_pwdn [ create_bd_port -dir O vid_pwdn ]
  set vid_vsync [ create_bd_port -dir I vid_vsync ]

  # Create instance: RGB2GBR_0, and set properties
  set RGB2GBR_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:RGB2GBR:1.0 RGB2GBR_0 ]
  ...
  # Create instance: bayer_capture_0, and set properties
  set bayer_capture_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:bayer_capture:1.0 bayer_capture_0 ]

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {257.011} \
   CONFIG.CLKOUT1_PHASE_ERROR {231.211} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {41.625} \
  ...
  # Create instance: frame_resize_0, and set properties
  set frame_resize_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:frame_resize:1.0 frame_resize_0 ]
  ...
  # Create instance: pwm_generate_0, and set properties
  set pwm_generate_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pwm_generate:1.0 pwm_generate_0 ]
  ...
  connect_bd_intf_net -intf_net RGB2GBR_0_OUTPUT_STREAM [get_bd_intf_pins RGB2GBR_0/OUTPUT_STREAM] [get_bd_intf_pins axis_broadcaster_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports vid_rst_n] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports lcd_rst_n] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins frame_resize_0/INPUT_STREAM]
  connect_bd_intf_net -intf_net bayer_capture_0_bayer [get_bd_intf_pins bayer_capture_0/bayer] [get_bd_intf_pins v_vid_in_axi4s_0/vid_io_in]
  connect_bd_intf_net -intf_net frame_resize_0_OUTPUT_STREAM [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM] [get_bd_intf_pins frame_resize_0/OUTPUT_STREAM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins RGB2GBR_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins pwm_generate_0/S0_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins bayer_capture_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins frame_resize_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  ...
  connect_bd_intf_net -intf_net v_demosaic_0_m_axis_video [get_bd_intf_pins RGB2GBR_0/INPUT_STREAM] [get_bd_intf_pins v_demosaic_0/m_axis_video]
  ...
  connect_bd_net -net RGB2GBR_0_interrupt [get_bd_pins RGB2GBR_0/interrupt] [get_bd_pins xlconcat_0/In6]
  ...
  connect_bd_net -net axi_vdma_1_mm2s_introut1 [get_bd_pins axi_vdma_0/mm2s_introut] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_vdma_1_s2mm_introut [get_bd_pins axi_vdma_1/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_vdma_1_s2mm_introut1 [get_bd_pins axi_vdma_0/s2mm_introut] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net bayer_capture_0_cam_pwdn [get_bd_ports vid_pwdn] [get_bd_pins bayer_capture_0/cam_pwdn]
  connect_bd_net -net bayer_capture_0_cmos_frame_ce [get_bd_pins bayer_capture_0/cmos_frame_ce] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net bayer_capture_0_cmos_frame_clk [get_bd_pins bayer_capture_0/cmos_frame_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_vdma_1/m_axis_mm2s_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rgb2lcd_0/pixel_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rgb2lcd_0/vid_rst]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins bayer_capture_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RGB2GBR_0/ap_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins bayer_capture_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins frame_resize_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_generate_0/s0_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pwm_generate_0_PWM_o [get_bd_ports PWM_o_0] [get_bd_pins pwm_generate_0/PWM_o]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RGB2GBR_0/ap_rst_n] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins bayer_capture_0/s00_axi_aresetn] [get_bd_pins frame_resize_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_generate_0/s0_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_demosaic_0/ap_rst_n]
  connect_bd_net -net v_demosaic_0_interrupt [get_bd_pins v_demosaic_0/interrupt] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net vid_data_1 [get_bd_ports vid_data] [get_bd_pins bayer_capture_0/cam_data]
  connect_bd_net -net vid_hsync_1 [get_bd_ports vid_hsync] [get_bd_pins bayer_capture_0/cam_href]
  connect_bd_net -net vid_pclk_1 [get_bd_ports vid_pclk] [get_bd_pins bayer_capture_0/cam_pclk]
  connect_bd_net -net vid_vsync_1 [get_bd_ports vid_vsync] [get_bd_pins bayer_capture_0/cam_vsync]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RGB2GBR_0/s_axi_AXILiteS/Reg] SEG_RGB2GBR_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_1_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bayer_capture_0/S00_AXI/S00_AXI_reg] SEG_bayer_capture_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs frame_resize_0/s_axi_AXILiteS/Reg] SEG_frame_resize_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_generate_0/S0_AXI/S0_AXI_reg] SEG_pwm_generate_0_S0_AXI_reg
